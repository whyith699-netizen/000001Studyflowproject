...
For cloud notes feature (non-Firebase storage):
...
Use `Applications/.env.production` (see `.env.production.example`):

```bash
VITE_NOTES_API_BASE_URL=https://your-worker-name.your-subdomain.workers.dev
