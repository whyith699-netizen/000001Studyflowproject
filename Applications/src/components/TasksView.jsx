...
const TasksView = () => {
    ...
    if (loading) return <div className="text-gray-900 dark:text-slate-100">Loading tasks...</div>;
    if (error) return <div className="text-gray-900 dark:text-slate-100">Error loading tasks: {error.message}</div>;
